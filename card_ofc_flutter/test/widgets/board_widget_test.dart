...
import 'package:card_ofc_flutter/ui/widgets/board_widget.dart';
import 'package:card_ofc_flutter/ui/widgets/line_slot_widget.dart';
...
void main() {
  group('BoardWidget', () {
    ...
    testWidgets('T5: onCardPlaced 콜백 - DragTarget 존재', (tester) async {
      ...
      expect(find.byType(DragTarget<ofc.Card>), findsWidgets);
